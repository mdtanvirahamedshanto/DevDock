...
export const MainLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#09090b] relative">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative z-10 p-4">
        ...
        <div className="flex-1 bg-card/40 backdrop-blur-2xl border border-white/5 rounded-2xl shadow-2xl overflow-hidden flex flex-col relative">
          {/* Top Toolbar - Drag region for frameless windows */}
          <header
            className="h-12 border-b border-white/5 flex items-center px-4 z-10 bg-transparent shrink-0"
          ...
          >
            ...
            >
              Press{' '}
              <kbd className="font-mono bg-white/5 px-1.5 py-0.5 rounded border border-white/10">
                ⌘ K
              </kbd>{' '}
              to search
            </div>
          ...
          {/* Status Bar */}
          <footer className="h-8 border-t border-white/5 flex items-center px-4 bg-transparent text-xs text-muted-foreground z-10 space-x-4 shrink-0">
